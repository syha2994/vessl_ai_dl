...
# === CONFIG ===
ORIG_IMG_DIR = '/Users/seungyeon/CREFLE/2.data/eq0/grounding-dino/dataset1/images/train'
ORIG_ANN_DIR = '/Users/seungyeon/CREFLE/2.data/eq0/grounding-dino/dataset1/annotations/train/labels'
TRAIN_DIR = '/Users/seungyeon/CREFLE/2.data/eq0/grounding-dino/dataset1/annotations'
TEST_DIR = '/Users/seungyeon/CREFLE/2.data/eq0/grounding-dino/dataset1/annotations'
NUM_TRAIN_IMAGES = 600
CSV_OUTPUT_FILENAME = 'analog_gauge_ann.csv'  # will be placed under TRAIN_DIR
    ...
    with open(output_csv, 'w', newline='') as csvfile:
        ...
        for fname in os.listdir(annotations_dir):
            ...
            for obj in root.findall('object'):
                ...
                bbox_width = int(float(xmax) - float(xmin))
                bbox_height = int(float(ymax) - float(ymin))
